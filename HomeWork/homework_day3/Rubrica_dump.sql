...
insert into contatti (id, name, surname, number, email, phone) values
						(1, 'Silverio', 'Vaira', '3348310267', 'silveiro.vaira@gmail.com', 6),
                        (2, 'Michele', 'Maselli', '3401079432', 'mikymas@tiscali.it', 6),
                        (3, 'Domenico', 'De Cesare', '3335682145', 'domendecesare@gmail.com',9),
                        (4, 'Filomena', 'Bernaudo', '3287612876', 'filober@hotmail.com', 8),
                        (5, 'Amalia', 'Silvestri', '3477654112', 'amysilvestri@gmail.com', 2),
                        (6, 'Davide', 'Del Sordo', '3338543672', 'davidedelsordo@tiscali.it',8);